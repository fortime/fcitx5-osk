...
impl<WM> WindowState<WM> {
    ...
    fn closing(&self) -> bool {
        match self.state {
            InnerWindowState::Closing(_) => true,
            _ => false,
        }
    }
}
    ...
    WM: WindowManager,
{
    ...
    pub fn placement(&self) -> Placement {
        match self.mode() {
            ...
            WindowManagerMode::WaylandInputPanel => Placement::Dock,
        }
    }
    ...
    pub fn indicator_display(&self) -> IndicatorDisplay {
        match self.mode() {
            ...
            WindowManagerMode::WaylandInputPanel => IndicatorDisplay::AlwaysOff,
        }
    }
    ...
    WM::Message: From<Message> + 'static + Send + Sync,
{
    ...
    fn update_mode(&mut self, mode: WindowManagerMode) -> Task<WM::Message> {
        let mut task = super::call_dbus(
            ...
            |s| async move {
                let mode = match mode {
                    ...
                    WindowManagerMode::WaylandInputPanel => {
                        entity::WindowManagerMode::WaylandInputPanel
                    }
                };
        ...
        match self.mode() {
            ...
            WindowManagerMode::WaylandInputPanel => task
