...
#[async_trait::async_trait]
impl<'a> IFcitx5ControllerService for Fcitx5ControllerServiceProxy<'a> {
    async fn full_input_method_group_info(&self, name: &str) -> ZbusResult<InputMethodGroupInfo> {
...
#[async_trait::async_trait]
impl<'a> IFcitx5VirtualKeyboardService for Fcitx5VirtualKeyboardServiceProxy<'a> {
    async fn show_virtual_keyboard(&self) -> ZbusResult<()> {
...
#[async_trait::async_trait]
impl<'a> IFcitx5VirtualKeyboardBackendService for Fcitx5VirtualKeyboardBackendServiceProxy<'a> {
    async fn process_key_event(
        &self,
        keyval: u32,
        keycode: u32,
